            ...
            runCatching {
                withContext(Dispatchers.IO) {
                    context.contentResolver.openInputStream(uri)?.use { input ->
                        ...
                        com.drawit.core.document.ImageShape(
...
private fun ToolBar(
    ...
    Row(
        ...
        ToolButton(
            icon = { Icon(Icons.Default.NearMe, "Select") },
            selected = toolHolder.activeToolId == "select",
        ...
        ToolButton(
            icon = { Icon(Icons.Default.Create, "Node Editor") },
            selected = toolHolder.activeToolId == "node",
            contentDescription = "Node Editor",
        ) {
            onStatusMessage(
        ...
        ToolButton(
            icon = { Icon(Icons.Default.Brush, "Freehand") },
            selected = toolHolder.activeToolId == "pen",
            contentDescription = "Freehand Pen",
        ) {
            toolHolder.activeToolId = "pen"
            toolHolder.pendingTool = PenTool(editorState)
        }
        ToolButton(
            icon = { Icon(Icons.Default.Polyline, "Bezier") },
            selected = toolHolder.activeToolId == "bezier",
            contentDescription = "Bezier Pen",
        ) {
            toolHolder.activeToolId = "bezier"
            toolHolder.pendingTool = BezierPenTool(editorState)
        }
        ToolButton(
            icon = { Icon(Icons.Default.CropSquare, "Rectangle") },
            selected = toolHolder.activeToolId == "rect",
        ...
        ToolButton(
            icon = { Icon(Icons.Default.Circle, "Ellipse") },
            selected = toolHolder.activeToolId == "ellipse",
        ...
        ToolButton(
            icon = { Icon(Icons.Default.ChangeHistory, "Polygon") },
            selected = toolHolder.activeToolId == "polygon",
        ...
        ToolButton(
            icon = { Icon(Icons.Default.TextFields, "Text") },
            selected = toolHolder.activeToolId == "text",
        ...
        ToolButton(
            icon = { Icon(Icons.Default.Article, "Paragraph") },
            selected = toolHolder.activeToolId == "paragraph",
